...
namespace FlexTemplate.Services
{
    public class ContextProvider
    {
        ...
        private async Task Initialize()
        {
            ...
            var tag1 = new Tag { Name = "Тег1", TagAliases = new List<TagAlias> { new TagAlias { Language = ukrainian, Text = "Тег один" } } };
            var tag2 = new Tag { Name = "Тег2" };
            var tag3 = new Tag { Name = "Тег3" };
            context.AddRange(
            new Blog
            {
                Author = user10,
                BlogTags = new List<BlogTag> { new BlogTag { Tag = tag1 }, new BlogTag { Tag = tag2 }, new BlogTag { Tag = tag3 } },
